...
| Workflow                             | Jobs                                                                                                                                                                                                                                              |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `.github/workflows/risk-service.yml` | `static` · `architecture` · `postgres` · `postgres-suite` (with OpenBao) · `storage` · `journeys` (Playwright + MinIO, dispatched manually via `dashboard-journeys.yml`; exact quarantine, size pinned) · `api-fresh` · `real-data` (conditional) |
