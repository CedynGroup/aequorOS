...
| Endpoint enforcement                 | Liquidity Monitoring is enforced by an exact active binding through a named route dependency. Coarse legacy dependencies still enforce viewer/analyst mutation separation and selected approver gates elsewhere; SSO membership and integration-key management use a separate account-administration gate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `app/api/deps.py`                                                                                                                                                                                                                                         |
