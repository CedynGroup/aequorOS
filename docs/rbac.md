...
1. Selected `approver` gates remain coarse legacy-rank checks rather than exact
   module/resource binding decisions. Integration-key issuance is the remaining
   account-plane scalar compatibility exception until issue #175.
