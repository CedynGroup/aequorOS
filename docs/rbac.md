...
>
> **Permission-only disabled controls:** When a Liquidity, IRRBB, FX, FTP, Forecasting, Behavioral, or Markets control is unavailable
...
| Identity in UI                       | Header + settings read the real session (name/role); route gate redirects unauthenticated → `/login`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `dashboard/components/shell/Header.tsx`, [dashboard route gate](../backend/dashboard/README.md#nextjs-16-runtime-conventions)                                                                                                                             |
