...
| 0:45 | Open **Covenant exception — Adom Textiles & Garments Ltd**.                                                                                                                                                        | “The risk score and open decision focus the reviewer on an active covenant exception without losing the borrower narrative.”                                         |
| 1:20 | Open **Financial Workspace**. Under **Unmapped source rows**, inspect the current-assets row. Under **Covenants**, open **Source** for **Minimum current ratio**.                                                  | “The signed source says 1.24x, while an OCR column shift produced 0.91x; row-level lineage makes the apparent breach explainable.”                                   |
...
| 6:00 | Open **Liquidity**, keep the downside scenario selected, and expand **Supporting evidence** on the highest-severity finding.                                                                                       | “The liquidity conclusion is generated from the forecast and links back to the exact period, canonical inputs, and reviewed assumptions.”                            |
| 7:00 | Open **Capital** and compare **Baseline** with **Downside — collections stress** by period.                                                                                                                        | “The same immutable forecast evidence drives the capital comparison, showing when balance-sheet pressure becomes a capital concern.”                                 |
| 8:00 | Open **Decisions**. Record **Needs more info** with reason `Obtain management confirmation of the corrected covenant certificate before committee.`                                                                | “The human decision remains explicit and auditable even when calculations and evidence are automated.”                                                               |
| 9:00 | Use the current-case selector to open **Completed review — Baobab Health Distribution SA**. Open **Report**, switch from **JSON** to **HTML**, and show the approval and monitoring finding.                       | “The completed case closes the loop: source-backed findings and the reviewer’s decision become a committee-ready report.”                                            |
...
- Kivu Fresh Produce Logistics has positive minimum cash under baseline and negative minimum cash
  under downside, with pre-generated liquidity evidence.
