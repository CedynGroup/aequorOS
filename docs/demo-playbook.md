...
| 6:00 | In **Current case**, open **Liquidity stress review — Kivu Fresh Produce Logistics Ltd**. Open **Forecast**, select **Downside — collections stress**, and run a new forecast. Open **Liquidity**, select the downside scenario, compare sources coverage with the labeled threshold, then expand **Supporting evidence** on the highest-severity finding. | “The persisted rule threshold and exact per-period values make the liquidity conclusion reproducible and link it back to canonical inputs and reviewed assumptions.”         |
| 7:00 | Open **Capital**, select the new downside forecast, and generate its projection. Compare the **Baseline** and **Downside** equity-to-assets lines, then confirm the ratios in the period comparison below.                                                                                                                                                 | “The same immutable Kivu forecast evidence drives both the visual trajectory and authoritative capital comparison.”                                                          |
