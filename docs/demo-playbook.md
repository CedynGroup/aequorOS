...
| 4:10 | Open **Forecast**. Select **Downside — collections stress** and click **Run forecast**. Use the **Balance-sheet trajectory** legend to compare assets, liabilities, and equity, then inspect **Projected balance sheet outputs**.                                                 | “The chart makes the trajectory visible while the authoritative table preserves the exact values; a rerun creates a new immutable snapshot and keeps seeded history intact.” |
...
| 6:00 | In **Current case**, open **Liquidity stress review — Kivu Fresh Produce Logistics Ltd**. Open **Liquidity**, select **Downside — collections stress**, compare sources coverage with the labeled threshold, then expand **Supporting evidence** on the highest-severity finding. | “The persisted rule threshold and exact per-period values make the liquidity conclusion reproducible and link it back to canonical inputs and reviewed assumptions.”         |
| 7:00 | Open **Capital** and compare the **Baseline** and **Downside** equity-to-assets lines, then confirm the ratios in the period comparison below.                                                                                                                                    | “The same immutable Kivu forecast evidence drives both the visual trajectory and authoritative capital comparison.”                                                          |
