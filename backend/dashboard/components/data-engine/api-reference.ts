...
export const PUSH_FLOW_STEPS: PushFlowStep[] = [
  ...
  },
  {
    ...
    summary:
      "Running totals of pages and records staged, and the committed batch id once committed.",
    ...
    fields: [
      {
        ...
        required: true,
        description:
          "Your stable identifier for the record (usually the account code).",
      },
      {
        name: "account_code",
        type: "string",
      ...
      },
      {
        ...
        type: "enum",
        required: true,
        description: "ASSET, LIABILITY, EQUITY, INCOME, EXPENSE, OFF_BALANCE.",
      },
      {
        ...
        required: false,
        description:
          "Parent GL code (hierarchy is wired when the parent is known).",
      },
      {
        name: "currency",
        type: "string",
      ...
      },
      {
        ...
        required: false,
        description:
          "Balance as of the as-of date. Enables GL vs sub-ledger reconciliation when positions carry gl_account_code.",
      },
      {
        name: "attributes",
        type: "object",
        required: false,
        description: "Free-form extras preserved verbatim.",
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        type: "string",
        required: true,
        description: "Your counterparty identifier.",
      },
      {
        name: "name",
        type: "string",
      ...
      },
      {
        ...
        required: true,
        description:
          "RETAIL_INDIVIDUAL, SME, CORPORATE, BANK_OECD, BANK_NON_OECD, CENTRAL_BANK, SOVEREIGN, GOVERNMENT_ENTITY, MULTILATERAL_DEV_BANK, NBFI, OTHER.",
      },
      {
        name: "country_code",
        type: "string",
      ...
      },
      {
        ...
        type: "string",
        required: false,
        description: "Group / parent counterparty reference.",
      },
      {
        name: "external_identifiers",
        type: "object",
        required: false,
        description: 'e.g. {"tin": "…", "lei": "…"} — preserved verbatim.',
      },
      {
        name: "attributes",
        type: "object",
    ...
    fields: [
      {
        ...
        type: "string",
        required: true,
        description: "Your product identifier (usually the product code).",
      },
      {
        name: "product_code",
        type: "string",
        required: true,
        description: "Product code positions reference.",
      },
      {
        name: "name",
        type: "string",
      ...
      },
      {
        ...
        required: false,
        description:
          "Canonical regulatory category; when omitted, the mapping config's product_mappings may supply it.",
      },
      {
        name: "risk_weight_code",
        type: "string",
        required: false,
        description: "Risk-weight bucket code.",
      },
      {
        name: "attributes",
        type: "object",
    ...
    fields: [
      {
        ...
        type: "string",
        required: true,
        description: "Your position identifier (arrangement id, deal ref, …).",
      },
      {
        name: "position_type",
        type: "enum",
        required: true,
        description:
          "LOAN, DEPOSIT, SECURITY_HOLDING, DERIVATIVE, FX_HEDGE, INTEREST_RATE_SWAP, CASH, INTERBANK_PLACEMENT, INTERBANK_BORROWING, LC_GUARANTEE, COMMITMENT_UNDRAWN, OTHER_ASSET, OTHER_LIABILITY.",
      },
      {
        name: "currency",
        type: "string",
        required: true,
        description: "ISO 4217 (validated).",
      },
      {
        name: "balance",
        type: "number",
        required: true,
        description: "Outstanding / carrying amount as of the as-of date.",
      },
      {
        name: "notional",
        type: "number",
        required: false,
        description:
          "Notional where distinct from balance (OBS, hedges, swaps).",
      },
      {
        name: "counterparty_reference",
        type: "string",
        required: false,
        description:
          "Must match a counterparty.source_reference in this push or previously ingested (gap = warning, not rejection).",
      },
      {
        name: "product_code",
        type: "string",
        required: false,
        description:
          "Must match a known product.product_code (dangling = error on the record).",
      },
      {
        ...
        required: false,
        description:
          "Must match a known gl_account.account_code; drives reconciliation.",
      },
      {
      ...
      {
        name: "contractual_maturity",
        type: "date",
        required: false,
        description: "Before the as-of date ⇒ warning.",
      },
      {
      ...
      },
      {
        ...
        required: false,
        description:
          "Decimal fraction (0.245 = 24.5%); outside [0, 1] ⇒ error on the record.",
      },
      {
        name: "rate_type",
        type: "enum",
      ...
      },
      {
        ...
        required: false,
        description:
          "Instrument specifics (hedge pair, contract rate, MtM, swap legs, ECL, branch, …) — preserved verbatim and used by module fact derivation.",
      },
    ],
  },
];
...
export const REFERENCE_KINDS: ReferenceKindSpec[] = [
  ...
  {
    key: "behavioral_assumptions",
    typicalFields: "product_code, assumption, value, …",
  },
  {
    key: "yield_curve",
    typicalFields: "curve_name, currency, tenor_months, rate, quote_date",
  },
  ...
  { key: "historical_cashflows", typicalFields: "date, inflow, outflow, …" },
  {
    ...
    typicalFields: "month, total_assets, net_income, …",
  },
...
export const VALUE_CONVENTIONS: { rule: string; detail: string }[] = [
  {
    rule: "Amounts",
    detail:
      'JSON number or plain numeric string (1500000.5 or "1500000.50"). No currency symbols or thousands separators.',
  },
  {
    rule: "Rates",
    detail:
      'Decimal fractions — 0.245 means 24.5%. Never "24.5%" and never bare percent numbers.',
  },
  { rule: "Dates", detail: 'ISO "YYYY-MM-DD" strings.' },
  {
    rule: "Nulls",
    detail: "JSON null (or omit the field). Empty strings are treated as null.",
  },
  {
    rule: "Unknown fields",
    detail:
      "Ignored unless captured via attributes or a mapping config's attribute_columns.",
  },
  {
    rule: "Bad records",
    detail:
      "Do NOT fail the request: they land in the batch's translation failures (raw record preserved) and the rest proceeds — same semantics as file ingestion.",
  },
];
