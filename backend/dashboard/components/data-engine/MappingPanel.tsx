...
/**
 * Excel/CSV mapping management: which mapping configuration is active for
 * file ingestion, plus starter-template activation for the Sample Bank
 * dataset. Mappings are the onboarding deliverable — one active per
 * (bank, source system); activating another creates a new audited version.
 */
    ...
    <section className="space-y-4">
      <div className="card p-5 border-l-4 border-l-success">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-h3 text-navy">Active mapping</h3>
        ...
        <p className="mt-2 text-body text-slate leading-relaxed">
          First-class onboarding path: workbook and CSV drops with mapping-driven
          translation, cell-level lineage, and validation gating.
        </p>
      ...
      <div className="card p-5">
        ...
        <p className="mt-1 text-body text-slate">
          Mappings translate each source column to a canonical field. One mapping is
          active per source system at a time; activating another creates a new version.
        </p>
