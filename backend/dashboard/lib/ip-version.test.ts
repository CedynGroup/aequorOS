...
const CORPUS: [string, string][] = [
  ...
  ["0177.0.0.1", "octal-ish leading zero"],
  ...
  ["", "empty"],
  [" ", "space"],
  ["1.1.1.01", "leading zero octet"],
  ["01.1.1.1", "leading zero first"],
  // IPv6 shapes
  ["::", "all zeros"],
  ["::0", ""],
  ["0:0:0:0:0:0:0:1", "uncompressed loopback"],
  ["1:2:3:4:5:6:7:8", "full"],
  ["1:2:3:4:5:6:7::", ":: for exactly one"],
  ["1:2:3:4:5:6:7:8::", ":: with 8 already"],
  ...
  ["::1.2.3.4", "quad tail"],
  ["::1.2.3.4.5", "bad quad"],
  ["1.2.3.4::", "quad at head"],
  ["::ffff:0:255.255.255.255", ""],
  ["FE80::1", "uppercase"],
  ["fE80::AbCd", "mixed case"],
  ["2001:db8::8a2e:370:7334", "documentation"],
  // zone ids — probed against node:net, not inferred
  ["fe80::1%eth0", "zone"],
  ["fe80::1%", "empty zone"],
  ["fe80::1%0", "numeric zone"],
  ["::1%eth0", "zone on loopback"],
  ["::%1", "zone on ::"],
  ["1.2.3.4%eth0", "v4 takes no zone"],
  ["fe80::1%eth0%x", "two zones"],
  ["%eth0", "zone only"],
  ["fe80::1% eth0", "space in zone"],
  ["fe80::1%eth0.5", "dotted zone"],
  ["1:2:3:4:5:6:7:8%z", "full with zone"],
];
...
if (failures > 0) {
  console.error(
    `ip-version.test.ts: ${failures} divergence(s) from node:net isIP (seed 20260821).`,
  );
  process.exit(1);
}
console.log(
  "ip-version.test.ts: ipVersion matches node:net isIP across corpus + 60000 fuzz cases.",
);
