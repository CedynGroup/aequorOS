...
_ROUTE_DEPENDENCIES = {
    ...
    ("POST", "/api/v1/banks/{bank_id}/capital-plan/approve"): "require_capital_plan_approve",
    ("POST", "/api/v1/banks/{bank_id}/capital-plan/ilaap-refresh"): "require_ilaap_refresh",
    ("GET", "/api/v1/banks/{bank_id}/capital-plan/ilaap"): "require_capital_confidential_view",
    ("GET", "/api/v1/banks/{bank_id}/sdi/capital-checks"): "require_capital_aggregated_view",
    ("GET", "/api/v1/banks/{bank_id}/sdi/capital-summary"): "require_capital_aggregated_view",
    ("GET", "/api/v1/banks/{bank_id}/sdi/capital-assurance"): "require_capital_restricted_view",
}
...
def test_capital_routes_cannot_revert_to_legacy_authorization() -> None:
